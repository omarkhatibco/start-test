...
export const Area = withContext<
	HTMLDivElement,
	Assign<JsxStyleProps, ColorPicker.AreaProps>
...
export const Label = withContext<
	HTMLLabelElement,
	Assign<JsxStyleProps, ColorPicker.LabelProps>
