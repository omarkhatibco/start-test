...
export const Input = withContext<
	HTMLInputElement,
	Assign<JsxStyleProps, DatePicker.InputProps>
>(DatePicker.Input, 'input')

export const Label = withContext<
	HTMLLabelElement,
	Assign<JsxStyleProps, DatePicker.LabelProps>
...
export const Table = withContext<
	HTMLTableElement,
	Assign<JsxStyleProps, DatePicker.TableProps>
...
export const View = withContext<
	HTMLDivElement,
	Assign<JsxStyleProps, DatePicker.ViewProps>
